% Implementation : Antoine Scherrer antoine.scherrer@ens-lyon.fr

% Altered by Konstantinos Konstantinidis in order for it to be able to
% accept very large sparse matrices
...
%
function [COMTY, ending] = comm_detect_louvain(M,s,self,debug,verbose)
